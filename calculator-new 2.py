...
def Demo():
    ...
    label=tkinter.Label(root, textvariable=CurrentShow,bg='black', anchor='e',bd=5,fg='white',font=('microsoft yahei',20))
    ...
    button3_1=tkinter.Button(text='7',bg='#666',bd=2,command=lambda:pressNumber('7'))
    button3_1.place(x=20,y=200,width=50,height=35)
    

    button3_2=tkinter.Button(text='8',bg='#666',bd=2,command=lambda:pressNumber('8'))
    button3_2.place(x=77.5,y=200,width=50,height=35)
    

    button3_3=tkinter.Button(text='9',bg='#666',bd=2,command=lambda:pressNumber('9'))
    button3_3.place(x=135,y=200,width=50,height=35)
    

    button3_4=tkinter.Button(text='/',bg='#666',bd=2,command=lambda:pressOperator('/'))
    button3_4.place(x=192.5,y=200,width=50,height=35)
  

    button3_5=tkinter.Button(text='%',bg='#666',bd=2,command=lambda:pressOperator('%'))
    button3_5.place(x=250,y=200,width=50,height=35)
    


    button4_1=tkinter.Button(text='4',bg='#666',bd=2,command=lambda:pressNumber('7'))
    button4_1.place(x=20,y=245,width=50,height=35)
   

    button4_2=tkinter.Button(text='5',bg='#666',bd=2,command=lambda:pressNumber('8'))
    button4_2.place(x=77.5,y=245,width=50,height=35)
    
    button4_3=tkinter.Button(text='6',bg='#666',bd=2,command=lambda:pressNumber('9'))
    button4_3.place(x=135,y=245,width=50,height=35)
   

    button4_4=tkinter.Button(text='*',bg='#666',bd=2,command=lambda:pressOperator('*'))
    button4_4.place(x=192.5,y=245,width=50,height=35)
    

    button4_5=tkinter.Button(text='1/x',bg='#666',bd=2,command=lambda:pressOperator('1/x'))
    button4_5.place(x=250,y=245,width=50,height=35)
    


    button5_1=tkinter.Button(text='3',bg='#666',bd=2,command=lambda:pressNumber('4'))
    button5_1.place(x=20,y=290,width=50,height=35)
    

    button5_2=tkinter.Button(text='2',bg='#666',bd=2,command=lambda:pressNumber('5'))
    button5_2.place(x=77.5,y=290,width=50,height=35)

    button5_3=tkinter.Button(text='1',bg='#666',bd=2,command=lambda:pressNumber('6'))
    button5_3.place(x=135,y=290,width=50,height=35)
    

    button5_4=tkinter.Button(text='-',bg='#666',bd=2,command=lambda:pressOperator('-'))
    button5_4.place(x=192.5,y=290,width=50,height=35)
   

    button5_5=tkinter.Button(text='=',bg='#666',bd=2,command=lambda:pressOperator('='))
    button5_5.place(x=250,y=290,width=50,height=35)
   

                        
    button6_1=tkinter.Button(text='0',bg='#666',bd=2,command=lambda:pressNumber('0'))
    button6_1.place(x=20,y=335,width=50,height=35)
    

    button6_2=tkinter.Button(text='.',bg='#666',bd=2,command=lambda:pressDP())
    button6_2.place(x=77.5,y=335,width=50,height=35)
   

    button6_3=tkinter.Button(text='+',bg='#666',bd=2,command=lambda:pressOperator('+'))
    button6_3.place(x=135,y=335,width=50,height=35)
